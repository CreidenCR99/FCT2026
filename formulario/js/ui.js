...
export function renderKPIs(data) {
	...
	morphdom(dom.kpiSection, tempDiv, {
		childrenOnly: true
	});
...
export function abrirModalError(errorObj) {
	...
	appState.currentModalData = {
		numeroSerie: errorObj.maquina.NumeroSerie,
		logId: errorObj.log.ID
	};
...
export function renderLogsNormal(data) {
	...
	morphdom(dom.logsNormalSection, tempDiv, {
		childrenOnly: true
	});
